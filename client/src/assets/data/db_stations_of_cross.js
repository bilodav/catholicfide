...
const stationOfCrossDataApi = [
  {
    ...
    reading:
      "And as soon as it was morning the chief priests, with the elders and scribes, and the whole council held a consultation; and they bound Jesus and led him away and delivered him to Pilate. And Pilate asked him, &ldquo;Are you the King of the Jews?&rdquo; And he answered him, &ldquo;You have said so.&rdquo; And the chief priests accused him of many things. And Pilate again asked him, &ldquo;Have you no answer to make? See how many charges they bring against you.&rdquo; But Jesus made no further answer, so that Pilate wondered. So Pilate, wishing to satisfy the crowd, released for them Barab&rsquo;bas; and having scourged Jesus, he delivered him to be crucified.",
  ...
  },
  {
    ...
    reading:
      "When the chief priests and the officers saw him, they cried out, &ldquo;Crucify him, crucify him!&rdquo; Pilate said to them, &ldquo;Take him yourselves and crucify him, for I find no crime in him.&rdquo; They cried out, &ldquo;Away with him, away with him, crucify him!&rdquo; Pilate said to them, &ldquo;Shall I crucify you King?&rdquo; The chief priests answered, &ldquo;We have no king but Caesar.&rdquo; Then he handed him over to them to be crucified. So they took Jesus, and he went out, bearing his own cross, to the place called the place of a skull, which is called in Hebrew Gol&rsquo;gotha.",
    v: "We adore you, Christ, and we praise you.",
    r: "Because by your holy Cross, you have redeemed the world.",
    meditation:
